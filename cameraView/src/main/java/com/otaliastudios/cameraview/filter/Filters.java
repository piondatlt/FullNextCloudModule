...
import com.otaliastudios.cameraview.filters.BulgeDistortionFilter;
...
import com.otaliastudios.cameraview.filters.GroupFilter;
...
public enum Filters {
    ...
    /** @see BulgeDistortionFilter */
    BULGE_DISTORT(BulgeDistortionFilter.class),

    /** @see GroupFilter */
    GROUP(GroupFilter.class),

    /** @see GroupAllFilter */
    GROUP_ALL(GroupAllFilter.class),
